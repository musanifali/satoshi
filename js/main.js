  ...
  const Header = (function () {
    ...
    function headerSticky() {
      ...
      window.addEventListener("scroll", () => {
        ...
        // Ensure the header is always visible at the top
    ...
    window.addEventListener("pageshow", function (event) {
      if (event.persisted) {
        document
          ...
          .classList.remove("is-hidden-on-scroll");
      }
    });
...
---------------------------------------------------*/
  ...
  function sectionSlider() {
    ...
    for (let i = 0; i < sectionSlider.length; i++) {
      ...
      if (el.hasAttribute("data-vertical")) vertical = "vertical";
      ...
      if (el.getAttribute("data-number-pagination")) {
        let paginationElement = document.querySelector(
          `.${el.getAttribute("data-number-pagination")}`
        );
      ...
      if (el.getAttribute("data-progress-pagination")) {
        let paginationElement = document.querySelector(
          `.${el.getAttribute("data-progress-pagination")}`
        );
    ...
    const slider = new Swiper(".js-testimonialsSlider-1", {
      ...
      navigation: {
        prevEl: document.querySelector(
          ".js-testimonialsSlider-1 .js-testimonialsSlider-1-prev"
        ),
        nextEl: document.querySelector(
          ".js-testimonialsSlider-1 .js-testimonialsSlider-1-next"
        ),
      },
    });

    const paginationItems = document.querySelectorAll(
      ".js-testimonialsSlider-1-pagination > *"
    );
    ...
    <div class="tourCard -type-1 pt-10 pb-15 px-10 border-1 rounded-12">
      ...
      <div class="tourCard__content px-10 pt-15">
        ...
        <h3 class="tourCard__title text-16 fw-500 mt-10">
          <span>Phi Phi Satoshi Global Villages Day Tour from Phuket</span>
        </h3>
  ...
  function menuFullScreen() {
    ...
    const openMenu = () => {
      ...
      const links = menu.querySelectorAll(
        ".js-menuFullScreen-links > .menuFullScreen-links__item > a"
      );
      const right = menu.querySelector(".js-menuFullScreen-right");
      const buttomMobile = menu.querySelector(
        ".js-menuFullScreen-buttomMobile"
      );
    ...
    const menuHasChildren = menu.querySelectorAll(
